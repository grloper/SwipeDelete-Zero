...
public final class DaggerSwipeDeleteApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends SwipeDeleteApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.deckBuilderProvider = DoubleCheck.provider(new SwitchingProvider<DeckBuilder>(singletonCImpl, 6));
      this.deckRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<DeckRepository>(singletonCImpl, 5));
      this.stagingRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<StagingRepository>(singletonCImpl, 7));
      this.backupRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<BackupRepository>(singletonCImpl, 8));
      this.exclusionRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<ExclusionRepository>(singletonCImpl, 9));
      this.noOpCloudBackupProvider = DoubleCheck.provider(new SwitchingProvider<NoOpCloudBackup>(singletonCImpl, 10));
      this.safStorageBridgeProvider = DoubleCheck.provider(new SwitchingProvider<SafStorageBridge>(singletonCImpl, 12));
      this.storagePermissionManagerProvider = DoubleCheck.provider(new SwitchingProvider<StoragePermissionManager>(singletonCImpl, 13));
      this.purgeEngineProvider = DoubleCheck.provider(new SwitchingProvider<PurgeEngine>(singletonCImpl, 11));
      this.statsStoreProvider = DoubleCheck.provider(new SwitchingProvider<StatsStore>(singletonCImpl, 14));
      this.noOpPhotosArchiveProvider = DoubleCheck.provider(new SwitchingProvider<NoOpPhotosArchive>(singletonCImpl, 15));
      this.mediaPreloaderProvider = DoubleCheck.provider(new SwitchingProvider<MediaPreloader>(singletonCImpl, 16));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 5: // com.swipedelete.zero.data.repository.DeckRepository 
          return (T) new DeckRepository(singletonCImpl.deckBuilderProvider.get(), singletonCImpl.deckSessionDao());

          case 6: // com.swipedelete.zero.domain.scanner.DeckBuilder 
          ...
          case 7: // com.swipedelete.zero.data.repository.StagingRepository 
          ...
          case 9: // com.swipedelete.zero.data.repository.ExclusionRepository 
          return (T) new ExclusionRepository(singletonCImpl.exclusionDao());

          case 10: // com.swipedelete.zero.domain.backup.NoOpCloudBackup 
          return (T) new NoOpCloudBackup();

          case 11: // com.swipedelete.zero.data.repository.PurgeEngine 
          ...
          case 12: // com.swipedelete.zero.data.repository.SafStorageBridge 
          ...
          case 13: // com.swipedelete.zero.data.repository.StoragePermissionManager 
          ...
          case 14: // com.swipedelete.zero.data.repository.StatsStore 
          ...
          case 15: // com.swipedelete.zero.domain.backup.NoOpPhotosArchive 
          return (T) new NoOpPhotosArchive();

          case 16: // com.swipedelete.zero.data.repository.MediaPreloader 
